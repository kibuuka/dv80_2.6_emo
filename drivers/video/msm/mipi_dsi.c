...
static void mipi_dsi_off1(struct platform_device *pdev);//CH MIPI Panel shutdown function
...
//B: CH MIPI Panel shutdown function
	//.shutdown = NULL,
	.shutdown = (void (*)(struct platform_device *)) mipi_dsi_off1, 
//E: CH MIPI Panel shutdown function
	.driver = {
		   .name = "mipi_dsi",
		   },
};
...
//B: CH MIPI Panel shutdown function
static void mipi_dsi_off1(struct platform_device *pdev)
{
	printk("DSPL ::%s: START \n", __func__);
