...
#define	T_SRC_WAKE_PULSE_WIDTH_1	(20-1)	// 20 milliseconds. Per MHL 1.0 Specs
#define	T_SRC_WAKE_PULSE_WIDTH_2	(60-2)	// 60 milliseconds. Per MHL 1.0 Specs
...
// Luke, fix HDMI sometimes hang when cable plug-in
#define	T_SRC_RXSENSE_CHK			(200)//(400)// Luke 14.3 patch

#define T_SWITCH_TO_USB             (100)
#define T_SWITCH_TO_MHL             (100)

#define T_D3_POLL_TIME              (100)
// Luke, fix HDMI sometimes hang when cable plug-in
#define T_D0_POLL_TIME              (100)
