...
typedef enum
{
	...
	,	MHL_TX_EVENT_DISCONNECTION		/* MHL connection has been lost */
	,	MHL_TX_EVENT_CONNECTION			/* MHL connection has been established */
	,	MHL_TX_EVENT_RCP_READY			/* MHL connection is ready for RCP */
	,	MHL_TX_EVENT_RCP_RECEIVED		/* Received an RCP. Key Code in "eventParameter" */
	,	MHL_TX_EVENT_RCPK_RECEIVED		/* Received an RCPK message */
	,	MHL_TX_EVENT_RCPE_RECEIVED		/* Received an RCPE message .*/
	,	MHL_TX_EVENT_DCAP_CHG			/* Received DCAP_CHG interrupt */
	,	MHL_TX_EVENT_DSCR_CHG			/* Received DSCR_CHG interrupt */
	,	MHL_TX_EVENT_POW_BIT_CHG		/* Peer's power capability has changed */
	,   MHL_TX_EVENT_RGND_MHL			/* RGND measurement has determine that the peer is an MHL device */
// put SP change event definition here
