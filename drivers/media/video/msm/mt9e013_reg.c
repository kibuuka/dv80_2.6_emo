...
#include "mt9e013.h"
#define SUPPORT_1080P_PREVIEW //[bug947] 1080p support, cci 20110926
...
//#ifndef SUPPORT_1080P_PREVIEW
#if 1 //[bug1178] To fix banding issue on 8M camera driver, cci 20111031
...
#else
//(Ext=24MHz, vt_pix_clk=182.4MHz, op_pix_clk=91.2MHz)*/
	{0x0300, 0x0005},/*VT_PIX_CLK_DIV*/
	{0x0302, 0x0001},/*VT_SYS_CLK_DIV*/
	{0x0304, 0x0002},/*PRE_PLL_CLK_DIV*/
	{0x0306, 0x004C},/*PLL_MULTIPLIER*/
	{0x0308, 0x000A},/*OP_PIX_CLK_DIV*/
	{0x030A, 0x0001},/*OP_SYS_CLK_DIV*/
#endif
};
...
static struct mt9e013_i2c_reg_conf prev_settings[] = {
	...
	{0x0202, 0x0581},/*COARSE_INTEGRATION_TIME*/
...
static struct mt9e013_i2c_reg_conf video_settings[] = {
//#ifndef SUPPORT_1080P_PREVIEW
#if 1 //full resolution update 1080p recording by VFE 
	/*Output Size (3264x1836)*/
	{0x0344, 0x0008},/*X_ADDR_START */
	{0x0348, 0x0CC7},/*X_ADDR_END*/
	{0x0346, 0x013A},/*Y_ADDR_START */
	{0x034A, 0x0865},/*Y_ADDR_END*/
	...
	{0x0404, 0x0010},/*SCALE_M*/
	/*Timing configuration*/
	{0x0342, 0x1254},/*LINE_LENGTH_PCK*/
	{0x0340, 0x07BB},/*FRAME_LENGTH_LINES*/
	{0x0202, 0x07BB},/*COARSE_INTEGRATION_TIME*/
	{0x3014, 0x03F6},/*FINE_INTEGRATION_TIME_ */
	{0x3010, 0x0078},/*FINE_CORRECTION*/
#else
	/*Output Size (1920x1088) FOV*/
	{0x0344, 0x01B8},/*X_ADDR_START*/
	{0x0348, 0x0B28},/*X_ADDR_END*/
	{0x0346, 0x022E},/*Y_ADDR_START*/
	{0x034A, 0x0792},/*Y_ADDR_END*/
	{0x034C, 0x0790},/*X_OUTPUT_SIZE*/
	{0x034E, 0x0450},/*Y_OUTPUT_SIZE*/
	...
	/*Timing configuration*/
	{0x0342, 0x1088},/*LINE_LENGTH_PCK*/
	{0x0340, 0x05D5},/*FRAME_LENGTH_LINES*/
	{0x0202, 0x05D5},/*COARSE_INTEGRATION_TIME*/
	{0x3014, 0x04FE},/*FINE_INTEGRATION_TIME_*/
	{0x3010, 0x00FC},/*FINE_CORRECTION*/
#endif
};
...
struct mt9e013_reg mt9e013_regs = {
	...
	.reg_video = &video_settings[0],
	.reg_video_size = ARRAY_SIZE(video_settings),
