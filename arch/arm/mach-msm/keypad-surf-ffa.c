...
#if 1
static struct gpio_event_input_info g_sKeypadDirectInfo;

#define CCI_MUTE_RING_GPIO                  34
//#define DA80_KEY_MUTE_RING                 KEY_MUTE

//Henry_lin, 20110721, [BugID 510] Add debounce function for volume up and volume down GPIO.
#if 1   // DA80 EVT2 define
#define CCI_VOLUME_UP_KEY_GPIO       96
#define CCI_VOLUME_DOWN_KEY_GPIO       99
#define DA80_KEY_VOLUMEUP                 KEY_VOLUMEUP
#define DA80_KEY_VOLUMEDOWN                 KEY_VOLUMEDOWN
#endif


//Henry_lin, 20110721, [BugID 510] Add debounce function for volume up and volume down GPIO.
static struct gpio_event_direct_entry g_sDirectKeys[] = {
//	{CCI_MUTE_RING_GPIO, DA80_KEY_MUTE_RING },
	{CCI_MUTE_RING_GPIO, KEY_MUTE },
	{CCI_VOLUME_UP_KEY_GPIO, DA80_KEY_VOLUMEUP },
	{CCI_VOLUME_DOWN_KEY_GPIO, DA80_KEY_VOLUMEDOWN },
};


static struct gpio_event_info *surf_keypad_info[] = {
	&g_sKeypadDirectInfo.info
};

static struct gpio_event_platform_data surf_keypad_data = {
//Henry_lin, 20110511, [BugID 86] Implement Ringer Switch.
//	.name		= "surf_keypad",
	.name		= "surf_keypad_mute",
//Henry_lin
	.info		= surf_keypad_info,
	.info_count	= ARRAY_SIZE(surf_keypad_info)
};
...
//	.flags	    =	GPIOEDF_PRINT_KEY_DEBOUNCE,
	.type = EV_KEY,
	.keymap = g_sDirectKeys,
	.keymap_size = ARRAY_SIZE(g_sDirectKeys)
};
#endif
//Henry_lin
