...
#add the macro for ecryptfs sync
ifndef CONFIG_SYNC_ECRYPTFS
KBUILD_CFLAGS       += -DCONFIG_SYNC_ECRYPTFS=y
endif
...
ifeq ($(CCI_KLOG_ALLOW_FORCE_PANIC),1)
	ifndef CONFIG_CCI_KLOG_ALLOW_FORCE_PANIC
		KBUILD_CFLAGS	+= -DCONFIG_CCI_KLOG_ALLOW_FORCE_PANIC=y
	endif # ifndef CONFIG_CCI_KLOG_ALLOW_FORCE_PANIC
endif # ifeq ($(CCI_KLOG_ALLOW_FORCE_PANIC),1)
endif # ifeq ($(CCI_KLOG_COLLECTOR),1)
#[DA80] <=== BugID#789 : CCI KLog Collector, added by Jimmy@CCI

ifeq ($(CCI_DEBUG_DL_MODE_STATUS),1)
        ifndef CONFIG_CCI_DEBUG_DL_MODE_STATUS
                KBUILD_CFLAGS   += -DCONFIG_CCI_DEBUG_DL_MODE_STATUS=y
        endif
endif
